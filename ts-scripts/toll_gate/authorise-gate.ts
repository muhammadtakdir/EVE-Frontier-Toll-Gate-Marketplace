...
async function authoriseGate(
    ...
    const authType = `${builderPackageId}::${MODULE.CONFIG}::TollAuth`;
    ...
    console.log("TollAuth extension authorized on gate!", gateId);
    console.log("Auth type:", authType);
    console.log("Transaction digest:", result.digest);
}

async function main() {
    console.log("============= Authorise Gate for Toll Extension ==============\n");
    try {
